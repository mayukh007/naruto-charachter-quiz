...
function getNext(){
	...
	while(a<= 20 && a>=17){
		if(document.getElementById("op"+a).checked == true){
			if(document.getElementById("op"+a).value == 'Obito'){
				count = count+100;
				getcount(count);
				k =k-4;
	...
	while(a<= 16 && a>=13){
	if(document.getElementById("op"+a).checked == true){
			if(document.getElementById("op"+a).value == 'Hatake'){
				count = count+100;
				getcount(count);
				k =k-4;
			    return 0;
	 ...
	 while(a<= 12 && a>=9){
	if(document.getElementById("op"+a).checked == true){
			if(document.getElementById("op"+a).value == 'lightning'){
				count = count+100;
				getcount(count);
				k =k-4;
			    return 0;
	 ...
	 while(a<= 8 && a>=5){
	if(document.getElementById("op"+a).checked == true){
			if(document.getElementById("op"+a).value == 'the copy ninja'){
				count = count+100;
				getcount(count);
				k =k-4;
			    return 0;
	...
	while(a<= 4 && a>=1){
	if(document.getElementById("op"+a).checked == true){
			if(document.getElementById("op"+a).value == '6'){
				count = count+100;
				getcount(count);
				k =k-4;
			    return 0;
